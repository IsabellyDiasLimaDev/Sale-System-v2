...
* Além disso deve baixar o sdk do JavaFx - https://gluonhq.com/products/javafx/ e o mysql connector em formato zip (plataform independent) -> https://downloads.mysql.com/archives/c-j/
