...
public class ListCashierOpenController implements Initializable {
	@FXML
			...
			try {
				if (newCashier != null) {
					...
					if (isClosing) {
						...
						Alert mensagem = new Alert(AlertType.ERROR);
						mensagem.setTitle("Erro!");
						mensagem.setHeaderText("Caixa j� aberto");
						mensagem.setContentText("Este caixa j� est� aberto! Selecione-o na lista de caixas abertos.");
						mensagem.showAndWait();
					}
