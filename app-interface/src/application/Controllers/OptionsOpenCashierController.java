	...
	public void returnSale() throws IOException{
		...
		try {
			...
			if(isActive) {
				...
				mensagem.setHeaderText("Sess�o entre caixa e usu�rio");
				mensagem.setContentText("Esta sess�o n�o correponde a este dia, for favor feche o caixa e abra uma nova sess�o!");
